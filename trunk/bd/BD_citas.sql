...
CREATE TABLE `citas_medicas` (
  ...
  `ia` double NOT NULL,
  `id_metodo_ia` int(10) unsigned NOT NULL,
  `hcg` double NOT NULL,
  `id_metodo_hcg` int(10) unsigned NOT NULL,
  `papa` double NOT NULL,
  `id_metodo_papa` int(10) unsigned NOT NULL,
  `tn` double NOT NULL,
  ...
  `fumadora` tinyint(1) unsigned NOT NULL,
  ...
  KEY `FK_citas_medicas_ia` (`id_metodo_ia`),
  KEY `FK_citas_medicas_hcg` (`id_metodo_hcg`),
  KEY `FK_citas_medicas_papa` (`id_metodo_papa`),
  KEY `FK_citas_medicas_tn` (`id_metodo_tn`),
  CONSTRAINT `FK_citas_medicas_ia` FOREIGN KEY (`id_metodo_ia`) REFERENCES `metodologia` (`id`),
  CONSTRAINT `FK_citas_medicas_hcg` FOREIGN KEY (`id_metodo_hcg`) REFERENCES `metodologia` (`id`),
  CONSTRAINT `FK_citas_medicas_papa` FOREIGN KEY (`id_metodo_papa`) REFERENCES `metodologia` (`id`),
  CONSTRAINT `FK_citas_medicas_tn` FOREIGN KEY (`id_metodo_tn`) REFERENCES `metodologia` (`id`),
  CONSTRAINT `FK_citas_medicas_afp` FOREIGN KEY (`id_metodo_afp`) REFERENCES `metodologia` (`id`),
  CONSTRAINT `FK_citas_medicas_medico` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id`),
  CONSTRAINT `FK_citas_medicas_paciente` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id`),
  CONSTRAINT `FK_citas_medicas_ue3` FOREIGN KEY (`id_metodo_ue3`) REFERENCES `metodologia` (`id`)
