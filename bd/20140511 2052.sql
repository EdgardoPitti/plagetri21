...
--
-- Table structure for table `plagetri21`.`etnia`
--
...
--
-- Dumping data for table `plagetri21`.`etnia`
--
...
CREATE TABLE `pacientes` (
  ...
  `edad_paciente` int(10) unsigned NOT NULL DEFAULT '0',
  `created_at` varchar(45) NOT NULL,
  `updated_at` varchar(45) NOT NULL,
  ...
  `id_nacionalidaad` int(10) unsigned NOT NULL DEFAULT '0',
  `id_etnia` int(10) unsigned NOT NULL DEFAULT '0',
